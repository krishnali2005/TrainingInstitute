...
<%
    // Session Verification & Role Extraction
...
<head>
    ...
    <style>
        ...
        .chart-container { background: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); max-width: 600px; margin: 20px auto; }
...
<div class="menu-grid">
    <% if ("ADMIN".equals(role)) { %>
        ...
        <a href="manage-courses.jsp" class="menu-card" style="border-top-color: #9b59b6;">
            <h3>📚 Course Curriculum</h3>
            <p>Define new training tracks, manage syllabus modules, or view track matrices.</p>
        </a>
    <% } %>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [<%= totalStudents %>, <%= totalLogs %>, <%= totalCollectedFees > 0 ? 1 : 0 %>], 
